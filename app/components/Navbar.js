            ...
            <div id='navbar' className='navbar-collapse collapse'>
                <form ref='searchForm' className='navbar-form navbar-left animated'
                    ...
                    <div className='input-group'>
                        <input type='text' className='form-control'
                               placeholder={this.state.totalCharacters + ' characters'} value={this.state.searchQuery}
                ...
                <ul className='nav navbar-nav'>
                    ...
                    <li className='dropdown'>
                        <a href='#' className='dropdown-toggle' data-toggle='dropdown'>Top 100
                    ...
                    <li className='dropdown'>
                        ...
                        <ul className='dropdown-menu'>
                            ...
                            <li className='dropdown-submenu'>
                                ...
                                <ul className='dropdown-menu'>
                                    <li><Link to='/male/Minmatar'>Minmatar</Link></li>
                                    <li><Link to='/male/Amaar'>Amaar</Link></li>
